package ru.mishenko.maksim.hybrid.core.network
...
class EitherAdapterFactory @Inject constructor() : CallAdapter.Factory() {
    override fun get(
        ...
        val errorBodyConverter = retrofit.responseBodyConverter<String>(
            String::class.java,
            annotations
        )
    ...
    private class ResultCallAdapter<R, T>(
        ...
        private val errorBodyConverter: Converter<ResponseBody, String>
    ) :
    ...
    private class ResultCallWrapper<F, T>(
        ...
        private fun getReasonByCode(
            ...
            404 -> ErrorReason.NotFound(errorResponse)
